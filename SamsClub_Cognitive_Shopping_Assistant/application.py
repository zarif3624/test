...
SEARCH_WITH_RANDR = 'search_randr'
...
def get_application_message(message):
	...
	print("application_message['chat']")
	print(application_message['chat'])
	#if (application_message['chat'].startswith(SEARCH_WITH_RANDR)):
	if (application_message['chat'].startswith(INVOKE_CUSTOM_SERVICE) and application_message['chat'].endswith(SEARCH_WITH_RANDR)):
	...
	if (application_message['chat'].startswith(INVOKE_CUSTOM_SERVICE) and application_message['chat'].endswith(EVALUATE_PREDICTIVE_MODEL)):
